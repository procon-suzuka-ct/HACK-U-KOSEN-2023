  ...
  return (
    <Stage width={window.innerWidth} height={window.innerHeight}>
      ...
      <Layer>
        ...
        <Text text="とってもおいしそうなけーきができたね。" x={right_width / 2 - height10 * 2.6} y={height10 * 1.5}
              fontSize={height10 * 0.35} align='center'/>
        <Text text="あとはぼくたちサンタにまかせて。" x={right_width / 2 - height10 * 2.2} y={height10 * 1.8}
              fontSize={height10 * 0.35} align='center'/>
        <Text text="クリスマスのたのしいよるに" x={right_width / 2 - height10 * 1.85} y={height10 * 2.1}
              fontSize={height10 * 0.35} align='center'/>
