    ...
    return(    
        <Stage width={window.innerWidth} height={window.innerHeight} >
            ...
            <Layer>
                ...
                <Text text="おかあさん、おとうさん"  x={right_width/2-height10*1.5} y={height10*2} fontSize={height10*0.35}  align='center'/>
                ...
                <Rect onClick={onClickPaymentpage} fill='#BDCCA9' x={width*0.07} y={height10*8.3} width={width10 * 6} height={width10*1.2} cornerRadius={70} />
                <Text onClick={onClickPaymentpage} x={width*0.35} y={height10*8.65} text="おわる" fontSize={height10*0.7} />
            </Layer>
        </Stage>
