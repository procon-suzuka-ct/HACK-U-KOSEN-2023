...
function Design() {
  ...
  const [cakeColor, setCakeColor] = useState("black");
  ...
  return (
    <Stage width={window.innerWidth} height={window.innerHeight} >
      ...
      <Layer>
        ...
        <Text x={width10 * 3.25} y={0} text={cakeColor} fontFamily="sans-serif" fontSize={width / 30} fill="black" />
      ...
      { bool_cakeColor &&
        <Layer>
          <Rect x={width10 * 2.9 - 25} y={bottom_height - 220} width={200} height={200} fill="#fffbf0" cornerRadius={20} stroke={"#63beff"} />
          <Text x={width10 * 2.9 - 10} y={bottom_height - 210} text="いろをえらんでね" fontStyle='bold' fontFamily="sans-serif" fontSize={20} fill="black" />
          <Rect onClick={() => { setCakeColor("red"); }} x={width10 * 2.9 - 10} y={bottom_height - 180} width={50} height={45} cornerRadius={10} fill="red" />
          <Rect onClick={() => { setCakeColor("pink"); }} x={width10 * 2.9 + 50} y={bottom_height - 180} width={50} height={45} cornerRadius={10} fill="pink" />
          <Rect onClick={() => { setCakeColor("orange"); }} x={width10 * 2.9 + 110} y={bottom_height - 180} width={50} height={45} cornerRadius={10} fill="orange" />
          <Rect onClick={() => { setCakeColor("yellow"); }} x={width10 * 2.9 - 10} y={bottom_height - 130} width={50} height={45} cornerRadius={10} fill="yellow" />
          <Rect onClick={() => { setCakeColor("yellowgreen"); }} x={width10 * 2.9 + 50} y={bottom_height - 130} width={50} height={45} cornerRadius={10} fill="yellowgreen" />
          <Rect onClick={() => { setCakeColor("green"); }} x={width10 * 2.9 + 110} y={bottom_height - 130} width={50} height={45} cornerRadius={10} fill="green" />
          <Rect onClick={() => { setCakeColor("cyan"); }} x={width10 * 2.9 - 10} y={bottom_height - 80} width={50} height={45} cornerRadius={10} fill="cyan" />
          <Rect onClick={() => { setCakeColor("blue"); }} x={width10 * 2.9 + 50} y={bottom_height - 80} width={50} height={45} cornerRadius={10} fill="blue" />
          <Rect onClick={() => { setCakeColor("yellow"); }} x={width10 * 2.9 + 110} y={bottom_height - 80} width={50} height={45} cornerRadius={10} fill="black" />
        </Layer>
      }
    </Stage>
